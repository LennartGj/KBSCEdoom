...
set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 PULLUP true } [get_ports { gpio_i[0] }]; # BTNL
set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS33 PULLUP true } [get_ports { gpio_i[1] }]; # BTNR
set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 PULLUP true } [get_ports { gpio_i[2] }]; # BNTU
set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 PULLUP true } [get_ports { gpio_i[3] }]; # BTND
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 PULLUP true } [get_ports { gpio_i[4] }]; # BTNC
