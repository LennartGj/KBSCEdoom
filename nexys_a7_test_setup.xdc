...
## GPIO inputs (PS/2 keycodes)
set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[0] }];
set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[1] }];
set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[2] }];
set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[3] }];
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[4] }];
set_property -dict { PACKAGE_PIN L17  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[5] }];
set_property -dict { PACKAGE_PIN K16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[6] }];
set_property -dict { PACKAGE_PIN J16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[7] }];
set_property -dict { PACKAGE_PIN H16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[8] }];
set_property -dict { PACKAGE_PIN G16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[9] }];
set_property -dict { PACKAGE_PIN F16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[10] }];
set_property -dict { PACKAGE_PIN E16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[11] }];
set_property -dict { PACKAGE_PIN D16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[12] }];
set_property -dict { PACKAGE_PIN C16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[13] }];
set_property -dict { PACKAGE_PIN B16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[14] }];
set_property -dict { PACKAGE_PIN A16  IOSTANDARD LVCMOS33 } [get_ports { gpio_i[15] }];
